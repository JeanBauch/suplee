<template>
  <div class="relative">
    ...
    <div v-else class="w-screen h-screen flex justify-center items-center">
      <h2 class="text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-semibold text-primary-olivia-dark text-center">
        Suplee indisponível no momento, volte mais tarde!
      </h2>
    </div>
  </div>
</template>
