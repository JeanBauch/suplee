<template>
  <div class="flex w-full max-w-[14rem] xl:max-w-none relative rounded-md">
    <input
      ...
      @focusin="$emit('onClickInput', true)"
      @focusout="$emit('onClickInput', false)"
    >
    ...
    <button :class="classColorCurrentCatergory" class="absolute top-0 right-0 w-11 2xl:w-12 h-11 2xl:h-12 flex justify-center items-center rounded-tr-md rounded-br-md">
