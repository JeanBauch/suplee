<template>
  <div class="relative group">
    ...
    <div v-if="useLoggedUser().user.isLogged" class="group-hover:flex hidden absolute flex-col right-0 bg-complement-background-normal rounded-md w-[150px] overflow-hidden z-30 transition-all">
